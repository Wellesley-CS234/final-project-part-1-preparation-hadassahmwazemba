...
st.write("The dataset used in this analysis was generated by parsing \
     WPPCC articles through the Wikipedia API and extracting the page size for each retrieved article. \
    A snippet of the data is provided below.")
